...
Para pivotear la matriza a formato ancho tenemos pivot_wider(names_from, values_from) de tidyr
names_from: especifica el nombre de una variable desde la que se obtienen los nombres de las nuevas columnas
values_from: especifica el nombre de una variable desde donde se obtienen los valoresd de las nuevas columnas
...
mu: valor nulo
stdev: desviacion estandar de la población
alternative: tipo de hipotesis alternativa, "two.sided","less","greater"
...
error_est <- sqrt((valor_nulo * (1 - valor_nulo))/n)
